...
const CompleteBilling = () => {
  ...
  const completeBillingOrders = useMemo(() => {
    ...
    return completeOrders.filter((item) => {
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            Showing <strong>{completeBillingOrders.length}</strong> pending
            orders
          </Typography>
        </Box>
      </Paper>
...
export default CompleteBilling;
